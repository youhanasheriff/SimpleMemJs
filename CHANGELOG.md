...
### Changed
- Rewrite README with complete documentation covering all features: abstract memory, event system, flexible input, all providers, all storage adapters, logging, full API reference, and contributor setup
